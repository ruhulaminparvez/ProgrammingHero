    ...
    parentDiv.innerHTML = `
      <div class="card h-100">
        ...
        <div class="card-footer">
          <button onclick="loadDetails('${phone.slug}')" class="btn btn-info text-white d-flex justify-content-center m-auto" data-bs-toggle="modal" data-bs-target="#phoneModal">View Details</button>
        </div>
      </div>
    `
